  ...
  class KPIWidget extends HTMLElement {
    ...
    async serializeCustomWidgetToImage() {
      ...
      if (this._showCurrency) {
        ...
        ctx.fillText("₹", 60 , 65 );                                   //-----------------------------------------------Value Position

        ctx.font = `bold ${this._valueFontSize}px Arial`;

        // const metrics = ctx.measureText(formattedValue);
        // const valueWidth = metrics.width;
        // const valueHeight = metrics.actualBoundingBoxAscent + metrics.actualBoundingBoxDescent;

        // ctx.fillText(formattedValue, ((width - 10) / 2) + (this._valueX / 2), ((height - 10) / 2) - (this._valueY / 2));
        // const pos_x = width - 15;
        // const pos_y = height - 15;
        
        ctx.fillText(formattedValue, 75 , 65 );     //old 20, 30        //-----------------------------------------------Value Position
      } else {
        ctx.font = `bold ${this._valueFontSize}px Arial`;
      ...
      if (this._showFooter) {
        ...
        ctx.fillText(this._unitText, 75, 80);                                            //-----------------------------------------------Unit Position
        ...
        ctx.fillText( this._description, 102, 80 );                                      //-----------------------------------------------Footer Position
      }
